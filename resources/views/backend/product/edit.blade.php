                            ...
                            <div class="row">
                                ...
                                <div class="card shadow-lg  p-3 bg-white rounded col-md-12">
                                    ...
                                    <div class="d-flex justify-content-start" id="database_images" style="border: 2px dashed;margin-top: 10px;">
                                        ...
                                        <img src="{{ asset('images/product/' . $url) }}" alt="Product Image" class="mr-2 mt-1 mb-1 ml-2" style="width: 100px; height: 150px; border:1px solid;">
                                        @else
                                        <img src="{{ $url }}" alt="Product Image" class="mr-2 mt-1 mb-1 ml-2" style="width: 100px; height: 150px;">
                                        @endif
                                        @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="barcode_symbology" required class="form-control selectpicker">
                                                <option value="{{$lims_product_data->barcode_symbology}}" selected>{{$lims_product_data->barcode_symbology}}</option>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="dbRows">
                                            ...
                                            <td class="variant-name mt-2">{{ $eachVariant->title }}
                                                <input type="hidden" name="variant_name[]" value="{{ $eachVariant->title }}"  /></td>
                                            <td>
                                                <input type="text" name="item_code[]" class="form-control" value="{{ $eachVariant->item_code }}" >
                                            </td>
                                            <td>
                                                <input type="number" name="additional_price[]" class="form-control" value="{{ $eachVariant->price }}" >
                                            </td>
                                            <td>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <select class="form-select border w-100" name="save_status" title="Select Status">
                                        <option value="{{$lims_product_data->status}}" selected>{{$lims_product_data->status}}</option>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Category...">
                                        <option value="{{$lims_product_data->category->id}}" selected>{{$lims_product_data->category->name}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select border w-100" aria-label="Default select example" title="Select Product type" name="prod_type" value="{{ old('prod_type') }}" style="border: 1px solid black; border-radius: 5px;">
                                    <option value="{{$lims_product_data->product_type}}" selected>{{$lims_product_data->product_type}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="brand_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Brand...">
                                        <option value="{{$lims_product_data->brand->id}}" selected>{{$lims_product_data->brand->title}}</option>
